                    ...
                    _createClass(LessPlugin, [
                        {
                            ...
                            value: function reload(path, options) {
                                if (
                                    ...
                                    if (
                                        options.originalPath.match(/\.less$/i)
                                    ) {
                    ...
                    function LiveReload(window) {
                        ...
                        this.connector = new Connector(
                            ...
                            Timer,
                            {
                                ...
                                connected: function connected(protocol) {
                                    if (
                                        typeof _this.listeners.connect ===
                                        "function"
                                    ) {
                                ...
                                error: function error(e) {
                                    if (e instanceof ProtocolError) {
                                        ...
                                        if (
                                            ...
                                            return console.log(
                                                "LiveReload internal error: ".concat(
                                                    e.message
                                                )
                                            );
                                        }
                                ...
                                disconnected: function disconnected(
                                    ...
                                    if (
                                        typeof _this.listeners.disconnect ===
                                        "function"
                                    ) {
                    ...
                    _createClass(LiveReload, [
                        ...
                        },
                        {
                            ...
                            value: function performReload(message) {
                                ...
                                return this.reloader.reload(message.path, {
                                    liveCSS:
                                        message.liveCSS != null
                                            ? message.liveCSS
                                            : true,
                                    liveImg:
                                        message.liveImg != null
                                            ? message.liveImg
                                            : true,
                                    reloadMissingCSS:
                        ...
                        },
                        {
                            ...
                            value: function shutDown() {
                                ...
                                return typeof this.listeners.shutdown ===
                                    "function"
                                ...
                                var plugin = new PluginClass(this.window, {
                                    ...
                                    generateCacheBustUrl:
                                        function generateCacheBustUrl(url) {
                                            return _this2.reloader.generateCacheBustUrl(
                                                url
                                            );
                                        },
                                });
                    ...
                    _createClass(Reloader, [
                        ...
                        },
                        {
                            ...
                            value: function reload(path) {
                                ...
                                for (
                                    var _i = 0,
                                        _Array$from = Array.from(this.plugins);
                                    _i < _Array$from.length;
                                    _i++
                                ) {
                            ...
                            value: function runPluginsByOrder(path, options) {
                                ...
                                options.pluginOrder.some(function (pluginId) {
                                    ...
                                    if (pluginId === "external") {
                                        return _this.plugins.some(function (
                                            plugin
                                        ) {
                                            return (
                                                plugin.reload &&
                        ...
                        },
                        {
                            ...
                            value: function reloadImages(path) {
                                ...
                                for (
                                    ...
                                    if (
                                        pathsMatch(path, pathFromUrl(img.src))
                                    ) {
                                ...
                                if (this.document.querySelectorAll) {
                                    for (
                                        var _i3 = 0,
                                            _IMAGE_STYLES = IMAGE_STYLES;
                                        _i3 < _IMAGE_STYLES.length;
                                        _i3++
                                    ) {
                                        var _IMAGE_STYLES$_i =
                                                _IMAGE_STYLES[_i3],
                                            selector =
                                                _IMAGE_STYLES$_i.selector,
                                            styleNames =
                                                _IMAGE_STYLES$_i.styleNames;
                                        for (
                                            var _i4 = 0,
                        ...
                        },
                        {
                            ...
                            value: function reloadStyleImages(
                                ...
                                var _this3 = this;
                                var _iterator2 =
                                        _createForOfIteratorHelper(styleNames),
                                    _step2;
                                try {
                                    for (
                                        _iterator2.s();
                                    ...
                                    for (
                                        var _i7 = 0,
                                            _Array$from5 = Array.from(
                                                _this4.document.getElementsByTagName(
                                                    "link"
                                                )
                                            );
